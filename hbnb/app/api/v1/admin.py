...
class AdminUsers(Resource):
    ...
    def post(self):
        ...
        return facade.admin_create_user(api.payload, current_user.get('id')), 201
...
class AdminUser(Resource):
    ...
    def put(self, user_id):
        ...
        current_user = get_jwt_identity()
        return facade.admin_update_user(user_id, api.payload, current_user.get('id'))
...
class AdminPlace(Resource):
    ...
    def put(self, place_id):
        ...
        current_user = get_jwt_identity()
        return facade.admin_manage_place(place_id, api.payload, current_user.get('id'))
...
class AdminAmenities(Resource):
    ...
    def post(self):
        ...
        current_user = get_jwt_identity()
        return facade.admin_manage_amenity(None, api.payload, current_user.get('id')), 201
...
class AdminAmenity(Resource):
    ...
    def put(self, amenity_id):
        ...
        current_user = get_jwt_identity()
        return facade.admin_manage_amenity(amenity_id, api.payload, current_user.get('id'))
