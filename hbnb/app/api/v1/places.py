...
place_model = api.model('Place', {
    ...
    'owner_id': fields.String(readonly=True, description='Owner identifier')
})
...
class Place(Resource):
    ...
    def put(self, place_id):
        ...
        try:
            ...
            if str(place.owner_id) != str(current_user.get('id')):
                api.abort(403, "Unauthorized: only the owner can modify this place")
    ...
    def delete(self, place_id):
        ...
        try:
            ...
            # Verify ownership
            if str(place.owner_id) != str(current_user.get('id')):
                api.abort(403, "Unauthorized: only the owner can delete this place")
